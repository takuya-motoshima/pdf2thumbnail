 ...
 */
export declare const getTotalNumberOfPages: (pdfPath: string) => Promise<number>;
/**
 ...
 */
export declare const writeThumbnails: (pdfPath: string, outputDir: string, options?: Partial<ThumbnailOptions>) => Promise<ThumbnailResult>;
